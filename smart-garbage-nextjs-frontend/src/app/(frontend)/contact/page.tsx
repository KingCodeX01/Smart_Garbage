...
const Page = () => {
    return (
        <div className={'main_padding mt-10'}>
            <div
                className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto w-full bg-white text-[#333] font-[sans-serif]">
                <div>
                ...
                <form className="ml-auo space-y-4">
                    ...
                    <input type='text' placeholder='Subject'
                           className="w-full rounded-md py-3 px-4 bg-gray-100 text-sm outline-[#007bff]"/>
                    <textarea placeholder='Message' rows={16}
                              className="w-full rounded-md px-4 bg-gray-100 text-sm pt-3 outline-[#007bff]"></textarea>
                    <button type='button'
                            className="text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-3 w-full">Send
                    </button>
                </form>
            </div>
        </div>
